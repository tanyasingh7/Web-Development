...
rgrandtotal = grandtotal.toFixed(2);
...
function total() {
  ...
  rgrandtotal = grandtotal.toFixed(2);
  if(shipping == 0){
    document.getElementById('grandtotal2').innerHTML= "Grand Total: $" + rgrandtotal;
  }
  else{
    grandtotal3 = grandtotal + shipping;
    rgrandtotal = grandtotal3.toFixed(2);
    document.getElementById('grandtotal2').innerHTML= "Grand Total: $" + rgrandtotal;
  }
  }
...
function shippingprice(){
  if(document.getElementById("shipping1").checked){
    ...
    rgrandtotal = grandtotal2.toFixed(2);
    shippingbool = true;
  }
...
document.getElementById("rgrandtotal").innerHTML= ("Grand Total: $"+rgrandtotal);
