...
function receipt() {
   var receiptelements = ['','first name','last name','phone number','email','','address','city','country','state','zip code','','the full name on your credit card','credit card number','expiration date','security code'];
   var len = obj.length;
   ...
   else if ((i == 10 ) && (obj.elements[i].value.length != 5)  )
{
...
else if ((i==13) && (obj.elements[i].value.length != 16))
{
...
else
{
  ...
  var d=new Date();
    ...
    console.log(year);
var firstname = obj.elements[1].value;
var lastname = obj.elements[2].value;
var phonenumber = obj.elements[3].value;
var email = obj.elements[4].value;
var address = obj.elements[6].value;
var city = obj.elements[7].value;
var country = obj.elements[8].value;
var state = obj.elements[9].value;
var zipcode = obj.elements[10].value;
var ccname = obj.elements[12].value;
var ccnumber = obj.elements[13].value;
var cclastfour = ccnumber.substring(ccnumber.length-4);
console.log('last four:',cclastfour);
var ccdate = obj.elements[14].value;
var cccode = obj.elements[15].value;
